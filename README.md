...
To install this Blender plugin, simply hit the green "Code" button near the top right of this repo, then hit the "download zip" option. Blender can then install that downloaded zip file.
